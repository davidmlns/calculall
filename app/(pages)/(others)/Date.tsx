...
export default function DateCalculator() {
  ...
  const calculateDifference = (startDate: Date, endDate: Date, unit: string) => {
    ...
    switch (unit) {
      case 'days':
        return t('dateCalculatorCard.daysResult', { days: daysDiff });
      case 'weeks':
        return t('dateCalculatorCard.weeksResult', { weeks: Math.floor(daysDiff / 7) });
      case 'months':
        const months =
          (endDate.getFullYear() - startDate.getFullYear()) * 12 +
          (endDate.getMonth() - startDate.getMonth());
        return t('dateCalculatorCard.monthsResult', { months });
      case 'years':
  ...
  return (
    <ScrollView className='bg-background-app w-full h-full'>
      ...
      <View className='flex mt-6 mx-auto px-4'>
        ...
        <View className='mt-6'>
          <Text className='text-gray-300 text-2xl mb-4 text-center'>
